...
import {getAllCompanyList} from "@/pages/cc/company/service";
    ...
    },
    {
      ...
      render: (_, record) => [
        <Button
          ...
          size="small"
          key="edit"
          hidden={!access.hasPerms('system:dept:edit')|| record.deptId==1}
          onClick={() => {
        ...
        <Button
          ...
          danger
          key="batchRemove"
          hidden={!access.hasPerms('system:dept:remove') || record.deptId==1}
          onClick={async () => {
            Modal.confirm({
              title: '删除',
              content: '确定删除该项吗？',
