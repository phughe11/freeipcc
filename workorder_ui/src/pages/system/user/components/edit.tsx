...
const UserForm: React.FC<UserFormProps> = (props) => {
  ...
  useEffect(() => {
    ...
    form.setFieldsValue({
      ...
      extension: props.values.extension,
      ctiAccount: props.values.ctiAccount,
      ...
      <Form form={form} onFinish={handleFinish} initialValues={props.values}>
        ...
        <Col span={12} order={1}>
          <ProFormText
            name="ctiAccount"
            label={intl.formatMessage({
              id: 'system.User.ctiAccount',
              defaultMessage: 'CTI帐号',
            })}
            width="xl"
            hidden={userId}
            placeholder="请输入CTI账号"
            rules={[
              {
                required: false,
                message: (
                  <FormattedMessage id="请输入CTI账号！" defaultMessage="请输入CTI账号！" />
                ),
              },
            ]}
          />
        ...
        <Col span={12} order={2}>
          <ProFormText
            ...
            rules={[
              {
                required: false,
                message: <FormattedMessage id="请输入分机！" defaultMessage="请输入分机！" />,
              },
            ]}
          />
        </Col>
